...
const Mutation = {
  stashables: (_, args, context) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const { supabase } = context
      return db.getStashables(supabase, args.filters)
    }),
  addStashable: (_, args, context) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const { supabase } = context
      console.log("adding stashable", args.link)
      return db.addStashable(supabase, args.link)
    }),
  deleteStashable: (_, args, context) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const { supabase } = context
      return db.deleteStashable(supabase, args.id)
    }),
  updateStashable: (_, args, context) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const { supabase } = context
