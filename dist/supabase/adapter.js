...
exports.updateStashable =
  exports.deleteStashable =
  exports.addStashable =
  exports.getStashables =
    void 0
const getStashables = (supabase, filter = {}) =>
...
const addStashable = (supabase, link) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteStashable = (supabase, id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { data, error } = yield supabase
      .from("stashable")
      .delete()
...
const updateStashable = (supabase, id, link) =>
  __awaiter(void 0, void 0, void 0, function* () {
